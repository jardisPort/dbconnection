# JardisPort DbConnection - Database Connection Interfaces
...
```bash
composer require jardisport/dbconnection
```
...
- `getReaders()`: Returns all configured reader connections as `array<DbConnectionInterface>`
- `getReaderCount()`: Returns the number of configured readers (minimum 1, as writer is used as fallback)
...
- Issues: https://github.com/JardisPort/dbconnection/issues
